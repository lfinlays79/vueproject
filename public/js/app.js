...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getMedicines: function getMedicines() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('http://127.0.0.1:8000/api/medicine/').then(function (response) {
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _vm.medicines.length === 0
        ? _c("p", [_vm._v("\n        You don't have any medicines\n    ")])
        : _vm._e(),
      _vm._v(" "),
      _vm.medicines.length > 0 ? _c("p") : _vm._e(),
      _vm._l(_vm.medicines, function(medicine) {
        return _c("p", { key: medicine.id }, [
          _vm._v("\n        " + _vm._s(medicine.name) + " "),
          _c("br"),
          _vm._v("\n        " + _vm._s(medicine.dosage) + "\n    ")
        ])
      })
    ],
    2
...
__webpack_require__(/*! /home/louise/git/vueproject/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/louise/git/vueproject/resources/css/app.css */"./resources/css/app.css");
